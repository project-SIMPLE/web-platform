...
class Model {
 ...
 constructor(controller) {
    ...
    this.json_players = {}
    try {
        this.json_settings = JSON.parse(fs.readFileSync('/home/asheleyine/github.com/ACROSS/nextjs_express_template/app/settings.json', 'utf-8'));
    } catch (err) {
        console.error('Unable to read settings.json:', err);
        this.json_settings = {}; // default settings
    }
